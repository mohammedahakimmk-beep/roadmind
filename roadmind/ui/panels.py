...
PERM_HINT = (
    ...
    "    - ONE exception: if your game runs AS ADMINISTRATOR, launch GameROBOT\n"
    "      as Administrator too (right-click the exe). Windows then blocks the\n"
    "      bot's keystrokes into the elevated game (UIPI) - it watches fine but\n"
    "      the car never moves. GameROBOT tells you when this is happening.\n"
    "    - if a game still ignores the keys (rare: raw input / anti-cheat),\n"
    "      rebind that control in the game instead.\n"
    "\n"
